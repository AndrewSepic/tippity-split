		...
		return (
			...
			{employeeData.map((employee) => (
				<div key={employee.id} className="employee my-2 flex justify-start">
					<h3 className="text-white py-2 w-[120px] font-bold">{employee.name}</h3>
					...
					<div className="w-[100px] text-white text-right px-2 placeholder-white  border-emerald-300 border-b-2 pt-2">${employee.tips}</div>
				</div>
			)	
			)}
		</>
